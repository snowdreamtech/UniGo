...
import (
	...
	"github.com/snowdreamtech/unigo/internal/addlicense"
...
Examples:
  unigo license add   -f .github/license-header.txt cmd/ internal/ scripts/
  unigo license check -f .github/license-header.txt cmd/ internal/ scripts/
  unigo license add   -l MIT -c "SnowdreamTech" -y 2026 cmd/`,
}
